...
public class DiscoveryTester {
    ...
    public static void main(String[] args) throws Exception {
                ...
                )
        {
            ...
            // N.B.: Use standardAdmin to bypass capture of metadata in ColumnManager
            ...
            try (Table table = standardConnection.getTable(MY_TABLE_NAME))
            {
                ...
                table.put(new Put(rowId1).
                            addColumn(MY_COLUMN_FAMILY_NAME, MY_SECOND_COLUMN_QUALIFIER,
                                                        Bytes.toBytes(" BIG DATA World!withExtraBytes")) );
                printColDescriptors(standardAdmin.getTableDescriptor(MY_TABLE_NAME));
            ...
            // Now use repositoryAdmin to capture all metadata
            repositoryAdmin.discoverMetadata();
            System.out.println("DUMPING REPOSITORY AFTER discovery of metadata");
