...
/**
 * Extension of standard HColumnDescriptor class which contains collections of
 * {@link ColumnAuditor} and {@link ColumnDefinition} components.
...
class MColumnDescriptor extends HColumnDescriptor {
    ...
    /**
     * Makes a deep copy of submitted HColumnDescriptor object; if submitted
     * object is also an MColumnDescriptor, deep copies of its component
     * {@link ColumnAuditor} and {@link ColumnDefinition} collections are also made.
    ...
    /**
     * This constructor accessed during deserialization process (a row of
     * column family type is read from repository table and deserialized
     * into a MetadataEntity object, which is then passed to this constructor
     * to complete the deserialization into an MColumnDescriptor object).
     * @param mEntity
     */
     ...
     * @return this object, to allow method chaining
     */
    MColumnDescriptor addColumnDefinitions
            (Collection<ColumnDefinition> columnDefinitions) {
        addColumnDefinitions(columnDefinitions.toArray
                                (new ColumnDefinition[columnDefinitions.size()]));
        return this;
    }
