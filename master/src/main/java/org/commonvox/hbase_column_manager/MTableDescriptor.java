...
/**
 * Extension of standard HTableDescriptor class which contains
 * {@link MColumnDescriptor} components, which in turn contain
 * {@link Column} and {@link ColumnDefinition} components.
...
//    private boolean columnDefinitionsEnforced;
    ...
    /**
     * The superclass constructor that is mirrored by this constructor is
     * slated for deprecation in HBase 2.0
     */
    MTableDescriptor() {
        super();
    }
    ...
    /**
     * Makes a deep copy of submitted HTableDescriptor object. If submitted
     * object is also an MTableDescriptor, a deep copy of its component
     * {@link MColumnDescriptor} collection is also made.
...
//        }
    ...
    /**
     * This constructor is accessed by {@link RepositoryAdmin} to retrieve an
     * {@link MTableDescriptor} that has its component {@link MColumnDescriptor}
     * objects populated with metadata retrieved from the {@link Repository}.
     * @param htd
     * @param repository
     * @throws IOException
     */
