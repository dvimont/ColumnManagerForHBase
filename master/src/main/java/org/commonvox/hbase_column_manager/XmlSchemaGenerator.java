...
/**
 * Used to generate an XML Schema (xsd) file which stipulates the layout of valid External Metadata
 * Archive XML documents. The xsd file is auto-generated by the JAXBContext#generateSchema method.
 * File is outputted to the project's root directory in the NetBeans environment.
 */
